...
CREATE TABLE IF NOT EXISTS document_chunks (
  ...
  content TEXT NOT NULL,
  content_vector vector(1536), -- Usamos un valor constante inicialmente, se actualizará dinámicamente
  content_hash TEXT, -- Nuevo para detectar duplicados
...
CREATE TABLE IF NOT EXISTS messages (
  ...
  content TEXT NOT NULL,
  embedding vector(1536), -- Usamos un valor constante inicialmente, se actualizará dinámicamente
...
CREATE TABLE IF NOT EXISTS vector_analytics (
  ...
  query TEXT NOT NULL,
  query_vector vector(1536), -- Usamos un valor constante inicialmente, se actualizará dinámicamente
