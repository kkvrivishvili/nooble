...
CREATE TABLE IF NOT EXISTS public.messages (
  ...
  content TEXT NOT NULL,
  embedding vector(1536), -- Se actualizará dinámicamente
  tokens_used INTEGER,
  latency_ms INTEGER,
...
CREATE TABLE IF NOT EXISTS app.vector_analytics (
  ...
  query TEXT NOT NULL,
  query_vector vector(1536), -- Se actualizará dinámicamente
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    BEGIN
      ...
      RAISE NOTICE 'Creada partición % para datos de vector_analytics', partition_name;
  ...
  IF NOT EXISTS (
    ...
    BEGIN
      ...
      RAISE NOTICE 'Creada partición anticipada %', partition_name;
    EXCEPTION WHEN OTHERS THEN
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      RAISE NOTICE 'Actualizado índice vectorial para partición %', partition_table;
    EXCEPTION WHEN OTHERS THEN
