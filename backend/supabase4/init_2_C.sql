...
DROP POLICY IF EXISTS ON app.users;
DROP POLICY IF EXISTS ON app.user_config;
DROP POLICY IF EXISTS ON app.subscription_plan_config;

-- Habilitar RLS básico en tablas internas
ALTER TABLE app.users ENABLE ROW LEVEL SECURITY;
ALTER TABLE app.user_config ENABLE ROW LEVEL SECURITY;
ALTER TABLE app.subscription_plan_config ENABLE ROW LEVEL SECURITY;

-- Aplicar política única simplificada
CREATE POLICY "Core tables access policy"
