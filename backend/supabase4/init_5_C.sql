...
-- Eliminar políticas RLS complejas previas
DROP POLICY IF EXISTS ON app.analytics;
DROP POLICY IF EXISTS ON app.system_errors;
DROP POLICY IF EXISTS ON app.usage_metrics;
DROP POLICY IF EXISTS ON app.quota_notifications;

-- Habilitar RLS básico en tablas de analytics
ALTER TABLE app.analytics ENABLE ROW LEVEL SECURITY;
ALTER TABLE app.system_errors ENABLE ROW LEVEL SECURITY;
ALTER TABLE app.usage_metrics ENABLE ROW LEVEL SECURITY;
ALTER TABLE app.quota_notifications ENABLE ROW LEVEL SECURITY;

-- Aplicar política única simplificada
